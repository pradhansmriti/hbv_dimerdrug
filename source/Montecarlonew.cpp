...
int attempt_add_monomer_dimer(Geometry &g, int heid0, gsl_rng *r) //!!! Should update with pre_oipen wedge
{
    ...
    if (vid0 >= 0 && g.v[g.vidtoindex[g.he[heindex0].vin]].hein.size() < 6 && g.v[g.vidtoindex[g.he[g.heidtoindex[g.he[heindex0].nextid]].vin]].hein.size() < 6)
    {
	    ...
	    etypenew=gsl_rng_uniform_int(r, 4);
            ...
            double gbb = g.find_dg(etypenew, etypeheid0, g.he[heindex0].din,g.he[heindex0].din);
            gbb += g.find_dg(etypexid, etypenew, drug0,g.he[g.heidtoindex[xid]].din);
    ...
    else if (vin0 >= 0 && g.v[g.vidtoindex[g.he[heindex0].vout]].hein.size() < 6 && g.v[g.vidtoindex[g.he[g.heidtoindex[g.he[heindex0].previd]].vin]].hein.size() < 6)
    {
	    ...
	    etypenew=gsl_rng_uniform_int(r, 4);
            ...
            double gbb = g.find_dg(etypenew, etypexid, g.he[g.heidtoindex[xid]].din,g.he[g.heidtoindex[xid]].din);
            gbb += g.find_dg(etypeheid0, etypenew, drug0,g.he[g.heidtoindex[xid]].din);
    ...
    else if (g.v[g.vidtoindex[g.he[heindex0].vin]].hein.size() < 6 && (g.v[g.vidtoindex[g.he[heindex0].vout]].hein.size()) < 6) //adding dimer
    {
        ...
        double gbb = g.find_dg(etypeheid0, etypenew1, drug1,g.he[heindex0].din);
        gbb += g.find_dg(etypenew1, etypenew2, drug2,drug2);
        gbb += g.find_dg(etypenew2, etypeheid0, g.he[heindex0].din,g.he[heindex0].din);
        //if
...
int attempt_remove_monomer_dimer(Geometry &g, int heid0, gsl_rng *r) /* 102220 THIS NEEDS UPDATE -> MOVE GEOMETRY TO geometry! */
{
    ...
    {                                                                                                                               //delete monomer
        ...
        gbb += g.find_dg(opprevtype, optype, g.he[heopindex0].din,g.he[prevopindex0].din);
        gbb += g.find_dg(optype, opnexttype, g.he[nextopindex0].din,g.he[heopindex0].din);
            ...
            else // edge is not wedge so remove dimer //with previous or next
    {
        ...
        if (g.is_boundary(heid_prev_boundary) > 0 && g.he[heindex_prev_boundary].previd == -1 && g.v[g.vidtoindex[g.he[heindex0].vin]].doubleboundary==-1) //delete dimer this and next (inside)(nextopindex) / this and prev (on boundary)  there should be nno bonds between this and previous
        {
            ...
            gbb += g.find_dg(optype, opnexttype, g.he[g.heidtoindex[nextopid0]].din,g.he[heopindex0].din);
            gbb += g.find_dg(opnexttype, opprevtype, g.he[prevopindex0].din,g.he[nextopindex0].din);
            gbb += g.find_dg(opprevtype, optype, g.he[heopindex0].din,g.he[prevopindex0].din);
        ...
        {                                                                 //delete dimer this and prev
            ...
            //gbb+= g.find_gbb(optype,opnexttype,opprevtype); //whole triangle
            gbb += g.find_dg(optype, opnexttype, g.he[g.heidtoindex[nextopid0]].din,g.he[heopindex0].din);
            gbb += g.find_dg(opnexttype, opprevtype, g.he[g.heidtoindex[prevopid0]].din,g.he[g.heidtoindex[nextopid0]].din);
            gbb += g.find_dg(opprevtype, optype, g.he[heopindex0].din,g.he[g.heidtoindex[prevopid0]].din);
...
int attempt_wedge_fusion(Geometry &g, gsl_rng *r)
{
    ...
    double e2 = g.find_dg(g.he[g.heidtoindex[heid_prev]].type, g.he[g.heidtoindex[heid_next]].type, g.he[heindex_next].din,g.he[heid_prev].din);

    if (bondnextm < 0)
    {
        e2 += g.find_dg(g.he[g.heidtoindex[heid_next]].type, g.he[g.heidtoindex[heidm]].type, g.he[g.heidtoindex[heidm]].din,g.he[heindex_next].din);
    }
    if (bondmprev < 0)
    {
        e2 += g.find_dg(g.he[g.heidtoindex[heidm]].type, g.he[g.heidtoindex[heid_prev]].type, g.he[g.heidtoindex[heid_prev]].din,g.he[g.heidtoindex[heidm]].din);
    }
...
int attempt_wedge_fission(Geometry &g, gsl_rng *r)
{
    ...
    e1 += g.find_dg(g.he[g.heidtoindex[xid]].type, g.he[g.heidtoindex[xidnextid]].type, g.he[g.heidtoindex[xidnextid]].din,g.he[g.heidtoindex[xid]].din);
    //int breakprevxid=-1;
    //int breaknextprev=-1;
    if (gsl_rng_uniform(r) < .5)
    { //BREAK prev- this
        // breakprevxid=g.he[g.heidtoindex[xidprevid]].vout;
        e1 += g.find_dg(g.he[g.heidtoindex[xidprevid]].type, g.he[g.heidtoindex[xid]].type, g.he[g.heidtoindex[xid]].din,g.he[g.heidtoindex[xidprevid]].din);
    ...
    else
    {
        ...
        //BREAK next-prev
        e1 += g.find_dg(g.he[g.heidtoindex[xidnextid]].type, g.he[g.heidtoindex[xidprevid]].type, g.he[g.heidtoindex[xidprevid]].din,g.he[g.heidtoindex[xidnextid]].din);
...
int attempt_change_edge_type_tri(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    e1 += g.find_dg(heidtype, nexttype, g.he[nextindex0].din,g.he[heindex0].din);
    e1 += g.dimer_bend_energy(heindex0);
    
    e1 += g.find_dg(prevtype, heidtype, g.he[heindex0].din,g.he[previndex0].din);
    e1 += g.dimer_bend_energy(previndex0);
    
    e1 += g.find_dg(nexttype, prevtype,g.he[previndex0].din,g.he[nextindex0].din);
    ...
    double e2 = 0;
    e1 += g.find_dg(newtype, next_newtype, g.he[nextindex0].din,g.he[heindex0].din);
    e1 += g.dimer_bend_energy(heindex0);
    
    e1 += g.find_dg(prev_newtype, newtype, g.he[heindex0].din,g.he[previndex0].din);
    e1 += g.dimer_bend_energy(previndex0);
    
    e1 += g.find_dg(next_newtype, prev_newtype,g.he[previndex0].din,g.he[nextindex0].din);
    e1 +=  g.dimer_bend_energy(nextindex0);
...
int attempt_change_edge_type(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    if (nextid0 != -1)
    {
        int nextindex0 = g.heidtoindex[nextid0];
        int nexttype = g.he[nextindex0].type;
        e1 += g.find_dg(oldtype, nexttype, g.he[nextindex0].din,g.he[heindex0].din);
    ...
    if (previd0 != -1)
    {
        int previndex0 = g.heidtoindex[previd0];
        int prevtype = g.he[previndex0].type;
        e1 += g.find_dg(prevtype, oldtype, g.he[heindex0].din,g.he[previndex0].din);
    ...
    if (nextopid0 != -1)
    {
        int nextopindex0 = g.heidtoindex[nextopid0]; // id of prev of opposite edge
        int opnexttype = g.he[nextopindex0].type;
        e1 += g.find_dg(optype, opnexttype, g.he[nextopindex0].din,g.he[heopindex0].din);
    ...
    if (prevopid0 != -1)
    {
        int prevopindex0 = g.heidtoindex[prevopid0];
        int opprevtype = g.he[prevopindex0].type;
        e1 += g.find_dg(opprevtype, optype, g.he[heopindex0].din,g.he[prevopindex0].din);
    ...
    if (nextid0 != -1)
    {
        int nextindex0 = g.heidtoindex[nextid0];
        int nexttype = g.he[nextindex0].type;
        e2 += g.find_dg(newtype, nexttype, g.he[nextindex0].din,g.he[heindex0].din);
    ...
    if (previd0 != -1)
    {
        int previndex0 = g.heidtoindex[previd0];
        int prevtype = g.he[previndex0].type;
        e2 += g.find_dg(prevtype, newtype, g.he[heindex0].din,g.he[previndex0].type);
    ...
    if (nextopid0 != -1)
    {
        int nextopindex0 = g.heidtoindex[nextopid0]; // id of prev of opposite edge
        int opnexttype = g.he[nextopindex0].type;
        e2 += g.find_dg(newoptype, opnexttype, g.he[nextopindex0].din,g.he[heindex0].din);
    ...
    if (prevopid0 != -1)
    {
        int prevopindex0 = g.heidtoindex[prevopid0];
        int opprevtype = g.he[prevopindex0].type;
        e2 += g.find_dg(opprevtype, newoptype, g.he[heopindex0].din,g.he[prevopindex0].din);
...
int attempt_fusion(Geometry &g, gsl_rng *r)
{
    ...
    double e2 = g.find_dg(g.he[g.heidtoindex[heid_prev]].type, g.he[g.heidtoindex[heid_next]].type, g.he[heindex_next].din,g.he[g.heidtoindex[heid_prev]].din);
...
int attempt_fission(Geometry &g, gsl_rng *r)
{
    ...
    //energy of initial configuration
    e1 += g.vertex_energy(vid0);
    e1 += g.find_dg(g.he[g.heidtoindex[heid_prev]].type, g.he[g.heidtoindex[heid_next]].type, g.he[g.heidtoindex[heid_next]].din,g.he[g.heidtoindex[heid_prev]].din);
...
int attempt_unbind_wedge_dimer(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    double de = -g.find_dg(g.he[previndex].type, g.he[nextindex].type, g.he[nextindex].din,g.he[previndex].din);
...
int attempt_bind_wedge_dimer(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    de += g.find_dg(g.he[heindexprev].type, g.he[heindexnext].type, g.he[heindexnext].din,g.he[heindexprev].din);
...
int attempt_bind_triangle(Geometry &g, int heid0, gsl_rng *r) //
{
    ...
    //std::cout << "1 de is "<< de<<endl;
    de += g.find_dg(g.he[prevboundaryindex0].type, g.he[heindex0].type, g.he[heindex0].din,g.he[prevboundaryindex0].din);
    de += g.find_dg(g.he[heindex0].type, g.he[nextboundaryindex0].type, g.he[nextboundaryindex0].din,g.he[heindex0].din);
...
int attempt_unbind_triangle(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    //std::cout << "1 de is "<< de<<endl;
    de -= g.find_dg(g.he[previndex0].type, g.he[heindex0].type, g.he[heindex0].din,g.he[previndex0].din);
    de -= g.find_dg(g.he[heindex0].type, g.he[nextindex0].type, g.he[nextindex0].din,g.he[heindex0].din);
...
int attempt_add_drug(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    e1 += g.dimer_bend_energy(previndex0);
    e1 += g.find_dg(g.he[previndex0].type, hetype, 0,g.he[previndex0].din);
    //}
    ...
    e2 += g.find_dg(g.he[previndex0].type, hetype, 1,g.he[previndex0].din);
    //}
    //else
    //{
    //  e2 += (g.gdrug-g.mudrug);
...
int attempt_remove_drug(Geometry &g, int heid0, gsl_rng *r)
{
    ...
    int previndex0 = g.heidtoindex[previd0];
    e1 += g.dimer_bend_energy(previndex0);
    e1 += g.find_dg(g.he[previndex0].type, hetype, 1,g.he[previndex0].din);
    ...
    e2 += g.dimer_bend_energy(previndex0);
    e2 += g.find_dg(g.he[previndex0].type, hetype, 0,g.he[previndex0].din);
    //std::cout<< "g.dimer_bend_energy(previndex0); " << g.dimer_bend_energy(previndex0)<<endl;
    //}
    double crit = exp((-(e2 - e1)) / g.T);
...
int force_add_monomer_with_next(Geometry &g, int heid0, int xid, gsl_rng *r)
{
    ...
    if (vid0 >= 0 && g.v[g.vidtoindex[g.he[heindex0].vin]].hein.size() < 6 && g.v[g.vidtoindex[g.he[g.heidtoindex[g.he[heindex0].nextid]].vin]].hein.size() < 6)
    {
		...
		etypenew=gsl_rng_uniform_int(r, 4);
            ...
            //std::cout << "g.he[heindex0].din" << g.he[heindex0].din<<endl;
            double gbb = g.find_dg(etypenew, etypeheid0, g.he[heindex0].din,0);
            gbb += g.find_dg(etypexid, etypenew, drug0,g.he[g.heidtoindex[xid]].din);
            //std::cout << "add_monomer with prev" <<endl;
